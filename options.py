...
class Options():
    def initialize(self):
        ...
        parser.add_argument('--test_input', dest='test_input', default='./test/input-sample8', help='dataset for testing')
        parser.add_argument('--test_labels', dest='test_labels', default='./test/labels-sample8', help='dataset for testing')
